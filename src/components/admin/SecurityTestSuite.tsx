        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className="bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 shadow-emerald-900/30"
              leftIcon={<Play className="w-4 h-4 fill-current" />}
            >
              {running ? 'Running Test Suite...' : 'Run All 17 Automated Tests'}
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          ...
          <div className="bg-slate-950 border border-slate-800 rounded-xl p-3 flex items-center justify-between">
            ...
            <Button
              ...
              className="p-1.5 text-slate-400 hover:text-white rounded-lg hover:bg-slate-800"
              aria-label="Copy npm run test:rules"
            >
          ...
          <div className="bg-slate-950 border border-slate-800 rounded-xl p-3 flex items-center justify-between">
            ...
            <Button
              ...
              className="p-1.5 text-slate-400 hover:text-white rounded-lg hover:bg-slate-800"
              aria-label="Copy npm run test:routes"
            >
              ...
              <div className="bg-slate-950 border border-slate-800/80 rounded-xl p-3 space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="text-[10px] text-slate-400 hover:text-white p-1 h-auto"
                    leftIcon={copiedSnippet === 'payload' ? <Check className="w-3 h-3 text-emerald-400" /> : <Copy className="w-3 h-3" />}
                  >
                    Copy JSON
                  </Button>
                </div>
